...
inputdir="data/multiface_subset/"
orientaionMapsDir="data/multiface_subset/orient"
confidenceValuesDir="data/multiface_subset/conf"
batch_name="multiface_test4"
output_dir_basename="results/$batch_name"
p_folder="data/multiface_subset/cam_param.txt"
scale=1
blocksize=11
iter=30
cost_gamma=10
